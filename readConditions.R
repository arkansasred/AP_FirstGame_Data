...
readAll<-function(){
    ...
    subjects<-subjects[!((subjects=="Subject 4") | (subjects=="Subject 5") | (subjects=="Subject 6") | (subjects == "Subject 1") | (subjects == "Subject 2"))]
    allData<-NULL
    i=1
    ...
    plot(levels[1,], col="red", main="Mean Score vs. Level", xlab="Level", ylab="Score", type='p', pch=19)
